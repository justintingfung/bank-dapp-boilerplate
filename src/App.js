...
function App() {
  ...
  const contractAddress = '0xBcbe6103647043023660B2a2Aa91676849b8bD22';
  ...
  // useEffect(() => {
  //   if (provider && signer && bankContract && isWalletConnected) {
  //   }
  // }, [ provider, signer, bankContract, isWalletConnected ])
